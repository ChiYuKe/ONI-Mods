...
共 44 个模块。新增模块时必须同步更新 HTML `nodeMeta`、JS `evaluatePreviewNode`、C# `EvaluateRuntimeNumber` switch、以及本文件。
...
| `music-sequencer` | `MusicSequencer` | 2 | 1 | 是 | 按 BPM 播放音符和休止步骤，输出 0-12 音符值 |
...
- [ ] 本文件更新
- [ ] 同步到 `bin/Release` 和 `Documents/.../Dev/LogicNetwork`
