    ...
    internal class STRINGS
    {
        public class CONFIGURATIONITEM
        {
            ...
            public class PLANTCONFIG
            {
                public class PLANT
                {
                    public static LocString ENABLECROPPATCH = "启用作物修改？";
                    public static LocString CROPDURATION = "作物生长时间";
                    public static LocString NUMPRODUCED = "作物收获数量";
                    ...
                    public static LocString PLANTFIBER = "释气草";
