...
namespace MiniBox
{
    internal class ModOptions
    {
        ...
        public class Settings : SingletonOptions<Settings>
        {
            ...
            //复制人睡觉
            [Option("STRINGS.CONFIGURATIONITEM.MISCCONFIG.MINIONSLEEP.TITLE", "STRINGS.CONFIGURATIONITEM.MISCCONFIG.MINIONSLEEP.TOOLTIP", OptionStrings.Misc.Category, Format = "F1")]
            [JsonProperty("NoWantSleepPatch")]
            public bool DisableFatigue { get; set; } = false;

            // 擦水
            [Option("STRINGS.CONFIGURATIONITEM.MISCCONFIG.WATERING.TITLE", "STRINGS.CONFIGURATIONITEM.MISCCONFIG.WATERING.TOOLTIP", OptionStrings.Misc.Category, Format = "F1")]
            [JsonProperty("WateringPatch")]
            public bool UnlimitedMopping { get; set; } = false;

            //超级太空服
            [Option("STRINGS.CONFIGURATIONITEM.MISCCONFIG.SUPERSPACESUIT.TITLE", "STRINGS.CONFIGURATIONITEM.MISCCONFIG.SUPERSPACESUIT.TOOLTIP", OptionStrings.Misc.Category, Format = "F1")]
            ...
            //运输存放器&运输装载器
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.SOLIDCONDUITOUTBOX.CAPACITY", "", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(20.0, 10000.0)]
            [JsonProperty]
            public float SolidConduitOutboxCapacityKg { get; set; } = 2000f;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.SOLIDCONDUITINBOX.CAPACITY", "", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(20.0, 10000.0)]
            [JsonProperty]
            public float SolidConduitInboxCapacityKg { get; set; } = 2000f;

            //储物箱
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.STORAGELOCKER.CAPACITY", "kg", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(0, 10000000)]
            [JsonProperty]
            ...
            //气库
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.GASRESERVOIR.CAPACITY", "kg", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(0, 100000)]
            [JsonProperty]
            public float GasReservoirCapacityKg { get; set; } = 20000f;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.GASRESERVOIR.FOUNDATION", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("GasReservoirFoundation")]
            public bool GasReservoirRequiresFoundation { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.GASRESERVOIR.OVERHEATABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            ...
            //液库
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.LIQUIDRESERVOIR.CAPACITY", "kg", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(0, 100000)]
            [JsonProperty]
            public float LiquidReservoirCapacityKg { get; set; } = 20000f;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.LIQUIDRESERVOIR.FOUNDATION", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("LiquidReservoirFoundation")]
            public bool LiquidReservoirRequiresFoundation { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.LIQUIDRESERVOIR.OVERHEATABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            ...
            // 电线配置项
            [Option(OptionStrings.Wiring.WireLoadKwTitle, "KW", OptionStrings.Wiring.WiringCategory, Format = "F0")]
            [Limit(0, 1000000)]
            [JsonProperty("Wires")]
            public float WireLoadKw { get; set; } = 1f;
            [Option(OptionStrings.Wiring.ConductiveWireLoadKwTitle, "KW", OptionStrings.Wiring.WiringCategory, Format = "F0")]
            [Limit(0, 1000000)]
            [JsonProperty("Conductors")]
            public float ConductiveWireLoadKw { get; set; } = 2f;
            [Option(OptionStrings.Wiring.HighLoadWireLoadKwTitle, "KW", OptionStrings.Wiring.WiringCategory, Format = "F0")]
            [Limit(0, 1000000)]
            [JsonProperty("HighLoadWires")]
            public float HighLoadWireLoadKw { get; set; } = 20f;
            [Option(OptionStrings.Wiring.HighLoadConductiveWireLoadKwTitle, "KW", OptionStrings.Wiring.WiringCategory, Format = "F0")]
            [Limit(0, 1000000)]
            ...
            //小变压器&大变压器
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.POWERTRANSFORMERSMALL.HEATGENERATION", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("PowerTransformerSmallHeatGeneration")]
            public bool EnableSmallPowerTransformerHeatGeneration { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.POWERTRANSFORMER.HEATGENERATION", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            ...
            //电解器制氧
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.MINERALDEOXIDIZER.TITLE", "kg", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [Limit(0, 1000000)]
            ...
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.MINERALDEOXIDIZER.FLOODABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("MineralDeoxidizerFloodable")]
            public bool MineralDeoxidizerCanFlood { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.MINERALDEOXIDIZER.OVERHEATABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("MineralDeoxidizerOverheatable")]
            public bool MineralDeoxidizerCanOverheat { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.MINERALDEOXIDIZER.HEATGENERATION", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            ...
            //冰箱
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.REFRIGERATOR.ENERGYCONSUMPTIONWHENACTIVE", "W", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [Limit(0, 500)]
            [JsonProperty("RefrigeratorEmissionValues")]
            public float RefrigeratorPowerConsumption { get; set; } = 120f;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.REFRIGERATOR.FLOODABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("RefrigeratorFloodable")]
            public bool RefrigeratorCanFlood { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.REFRIGERATOR.OVERHEATABLE", "", OptionStrings.Buildings.BuildingCategory, Format = "F0")]
            [JsonProperty("RefrigeratorOverheatable")]
            public bool RefrigeratorCanOverheat { get; set; } = true;
            [Option("STRINGS.CONFIGURATIONITEM.BUILDDINGS.REFRIGERATOR.CAPACITY", "Kg", OptionStrings.Buildings.CapacityCategory, Format = "F0")]
            [Limit(0, 1000000)]
            [JsonProperty]
            ...
            [Option(OptionStrings.Plant.EnableCropPatch, "", "")]
            [JsonProperty]
            public bool EnableCropPatch { get; set; } = true;


            // === 米虱木 (BasicPlantFood) 600/1===
            [Option(OptionStrings.Plant.BasicPlantFoodTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1800)]
            [JsonProperty]
            public float BasicPlantFood_GrowTime { get; set; } = 1800f;
            [Option(OptionStrings.Plant.BasicPlantFoodTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(1, 10000)]
            [JsonProperty]
            public int BasicPlantFood_Yield { get; set; } = 1;

            // === 毛刺花 (PrickleFruit) ===
            [Option(OptionStrings.Plant.PrickleFruitTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 3600)]
            [JsonProperty]
            public float PrickleFruit_GrowTime { get; set; } = 3600f;
            [Option(OptionStrings.Plant.PrickleFruitTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(1, 10000)]
            [JsonProperty]
            public int PrickleFruit_Yield { get; set; } = 1;

            // === 沼浆笼 (SwampFruit) ===
            [Option(OptionStrings.Plant.SwampFruitTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 3960)]
            [JsonProperty]
            public float SwampFruit_GrowTime { get; set; } = 3960f;
            [Option(OptionStrings.Plant.SwampFruitTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(1, 10000)]
            [JsonProperty]
            public int SwampFruit_Yield { get; set; } = 1;

            // === 夜幕菇 (Mushroom) ===
            [Option(OptionStrings.Plant.MushroomTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 4500)]
            [JsonProperty]
            public float Mushroom_GrowTime { get; set; } = 4500f;
            [Option(OptionStrings.Plant.MushroomTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(1, 10000)]
            [JsonProperty]
            public int MushroomPlant_Yield { get; set; } = 1;

            // === 冰霜小麦 (ColdWheatSeed) ===
            [Option(OptionStrings.Plant.ColdWheatSeedTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 10800)]
            [JsonProperty]
            public float ColdWheatSeed_GrowTime { get; set; } = 10800f;
            [Option(OptionStrings.Plant.ColdWheatSeedTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(18, 10000)]
            [JsonProperty]
            public int ColdWheatSeed_Yield { get; set; } = 18;

            // === 火椒藤 (SpiceNut) ===
            [Option(OptionStrings.Plant.SpiceNutTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 4800)]
            [JsonProperty]
            public float SpiceNut_GrowTime { get; set; } = 4800f;
            [Option(OptionStrings.Plant.SpiceNutTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(4, 10000)]
            [JsonProperty]
            public int SpiceNut_Yield { get; set; } = 4;

            // === 顶针芦苇 (BasicFabric) ===
            [Option(OptionStrings.Plant.BasicFabricTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1200)]
            [JsonProperty]
            public float BasicFabric_GrowTime { get; set; } = 1200f;
            [Option(OptionStrings.Plant.BasicFabricTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(1, 10000)]
            [JsonProperty]
            public int BasicFabric_Yield { get; set; } = 1;

            // === 芳香百合 (SwampLilyFlower) ===
            [Option(OptionStrings.Plant.SwampLilyFlowerTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 7200)]
            [JsonProperty]
            public float SwampLilyFlower_GrowTime { get; set; } = 7200f;
            [Option(OptionStrings.Plant.SwampLilyFlowerTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(2, 10000)]
            [JsonProperty]
            public int SwampLilyFlower_Yield { get; set; } = 2;

            // === 释气草 (PlantFiber) ===
            [Option(OptionStrings.Plant.PlantFiberTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 2400)]
            [JsonProperty]
            public float PlantFiber_GrowTime { get; set; } = 2400f;
            [Option(OptionStrings.Plant.PlantFiberTitle, "", OptionStrings.Plant.NumProducedCategory)]
            [Limit(400, 10000)]
            [JsonProperty]
            ...
            // === 木材 (WoodLog) ===
            [Option(OptionStrings.Plant.WoodLogTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 2700)]
            [JsonProperty]
            public float WoodLog_GrowTime { get; set; } = 2700f;
            [Option(OptionStrings.Plant.WoodLogTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(300, 100000)]
            [JsonProperty]
            public int WoodLog_Yield { get; set; } = 300;

            // === 蜜露 (SugarWater) ===
            [Option(OptionStrings.Plant.SugarWaterTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 150)]
            [JsonProperty]
            public float SugarWater_GrowTime { get; set; } = 150f; 

            [Option(OptionStrings.Plant.SugarWaterTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(20, 100000)]
            [JsonProperty]
            public int SugarWater_Yield { get; set; } = 20;

            // === 糖心树木材 (SpaceTreeBranch) ===
            [Option(OptionStrings.Plant.SpaceTreeBranchTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 2700)]
            [JsonProperty]
            public float SpaceTreeBranch_GrowTime { get; set; } = 2700f;

            [Option(OptionStrings.Plant.SpaceTreeBranchTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            public int SpaceTreeBranch_Yield { get; set; } = 1;

            // === 刺壳果灌木 (HardSkinBerry) ===
            [Option(OptionStrings.Plant.HardSkinBerryTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1800)]
            [JsonProperty]
            public float HardSkinBerry_GrowTime { get; set; } = 1800f;

            [Option(OptionStrings.Plant.HardSkinBerryTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            public int HardSkinBerry_Yield { get; set; } = 1;

            // === 羽叶果薯 (Carrot) ===
            [Option(OptionStrings.Plant.CarrotTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 5400)]
            [JsonProperty]
            public float Carrot_GrowTime { get; set; } = 5400f;

            [Option(OptionStrings.Plant.CarrotTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(0, 100000)]
            [JsonProperty]
            ...
            // === 漫殖藤 (VineFruit) ===
            [Option(OptionStrings.Plant.VineFruitTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1800)]
            [JsonProperty]
            public float VineFruit_GrowTime { get; set; } = 1800f;
            [Option(OptionStrings.Plant.VineFruitTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            ...
            // === 多孔芦荟 (OxyRock) ===
            [Option(OptionStrings.Plant.OxyRockTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1200)]
            [JsonProperty]
            public float OxyRock_GrowTime { get; set; } = 1200f;

            [Option(OptionStrings.Plant.OxyRockTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(2, 100000)]
            [JsonProperty]
            public int OxyRock_Yield { get; set; } = 36;

            // === 生菜 (Lettuce) ===
            [Option(OptionStrings.Plant.LettuceTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 7200)]
            [JsonProperty]
            public float Lettuce_GrowTime { get; set; } = 7200f;
            [Option(OptionStrings.Plant.LettuceTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(12, 100000)]
            [JsonProperty]
            public int Lettuce_Yield { get; set; } = 12;

            // === 海梳蕨 (Kelp) ===
            [Option(OptionStrings.Plant.KelpTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 3000)]
            [JsonProperty]
            public float Kelp_GrowTime { get; set; } = 3000f;
            [Option(OptionStrings.Plant.KelpTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(50, 100000)]
            [JsonProperty]
            ...
            // === 小吃芽 (BeanPlantSeed) ===
            [Option(OptionStrings.Plant.BeanPlantSeedTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 12600)]
            [JsonProperty]
            public float BeanPlantSeed_GrowTime { get; set; } = 12600f;
            [Option(OptionStrings.Plant.BeanPlantSeedTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(12, 100000)]
            [JsonProperty]
            ...
            // === 植物肉 (PlantMeat) ===
            [Option(OptionStrings.Plant.PlantMeatTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 18000)]
            [JsonProperty]
            public float PlantMeat_GrowTime { get; set; } = 18000f;
            [Option(OptionStrings.Plant.PlantMeatTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(10, 100000)]
            [JsonProperty]
            ...
            // === 贫瘠虫果 ===
            [Option(OptionStrings.Plant.WormBasicFruitTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 2400)]
            [JsonProperty]
            public float WormBasicFruit_GrowTime { get; set; } = 2400f;
            [Option(OptionStrings.Plant.WormBasicFruitTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            public int WormBasicFruit_Yield { get; set; } = 1;

            // === 虫果 ===
            [Option(OptionStrings.Plant.WormSuperFruitTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 4800)]
            [JsonProperty]
            public float WormSuperFruit_GrowTime { get; set; } = 4800f;
            [Option(OptionStrings.Plant.WormSuperFruitTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(8, 100000)]
            [JsonProperty]
            ...
            // === 露珠藤 ===
            [Option(OptionStrings.Plant.DewDripTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1200)]
            [JsonProperty]
            public float DewDrip_GrowTime { get; set; } = 1200f;
            [Option(OptionStrings.Plant.DewDripTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            public int DewDrip_Yield { get; set; } = 1;

            // === 巨蕨 ===
            [Option(OptionStrings.Plant.FernFoodTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 5400)]
            [JsonProperty]
            public float FernFood_GrowTime { get; set; } = 5400f;
            [Option(OptionStrings.Plant.FernFoodTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(36, 100000)]
            [JsonProperty]
            public int FernFood_Yield { get; set; } = 36;

            // === 沙盐藤 ===
            [Option(OptionStrings.Plant.SaltTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 3600)]
            [JsonProperty]
            public float Salt_GrowTime { get; set; } = 3600f;
            [Option(OptionStrings.Plant.SaltTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(65, 100000)]
            [JsonProperty]
            public int Salt_Yield { get; set; } = 65;

            // === 仙水掌 ===
            [Option(OptionStrings.Plant.WaterTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 6000)]
            [JsonProperty]
            public float Water_GrowTime { get; set; } = 6000f;
            [Option(OptionStrings.Plant.WaterTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(350, 100000)]
            [JsonProperty]
            public int Water_Yield { get; set; } = 350;

            // === 露饵花 ===
            [Option(OptionStrings.Plant.AmberTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 7200)]
            [JsonProperty]
            public float Amber_GrowTime { get; set; } = 7200f;
            [Option(OptionStrings.Plant.AmberTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(264, 100000)]
            [JsonProperty]
            public int Amber_Yield { get; set; } = 264;

            // === 汗甜玉米 800/1===
            [Option(OptionStrings.Plant.GardenFoodPlantFoodTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 1800)]
            [JsonProperty]
            public float GardenFoodPlantFood_GrowTime { get; set; } = 1800f;
            [Option(OptionStrings.Plant.GardenFoodPlantFoodTitle, "", OptionStrings.Plant.NumProducedCategory, Format = "F0")]
            [Limit(1, 100000)]
            [JsonProperty]
            public int GardenFoodPlantFood_Yield { get; set; } = 1;

            // === 拟芽 ===
            [Option(OptionStrings.Plant.ButterflyTitle, "", OptionStrings.Plant.CropDurationCategory, Format = "F1")]
            [Limit(0, 3000)]
            [JsonProperty]
