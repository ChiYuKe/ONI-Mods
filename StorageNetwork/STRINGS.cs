    ...
    internal class STRINGS
    {
        ...
        public class UI
        {
            public class STORAGE_NETWORK
            {
                ...
                public static LocString LOGIC_DIY_THRESHOLD = "判断阈值";
                public static LocString LOGIC_DIY_THRESHOLD_TOOLTIP = "选择用于比较的材料数量。";
                public static LocString LOGIC_DIY_THRESHOLD_PICKER_TITLE = "选择判断阈值";
                public static LocString LOGIC_DIY_THRESHOLD_CURRENT = "当前阈值：{0}";
                ...
                public static LocString LOGIC_DIY_SETTING_THRESHOLD = "判断阈值";
                ...
                public static LocString LOGIC_DIY_NODE_MATERIAL = "材料模块";
                public static LocString LOGIC_DIY_NODE_COMPARE = "判断模块";
                public static LocString LOGIC_DIY_NODE_FIXED = "固定输出模块";
                public static LocString LOGIC_DIY_NODE_OUTPUT = "输出模块";
                public static LocString LOGIC_DIY_CONNECT_TO_COMPARE = "判断";
