...
namespace StorageNetwork.UI
{
    internal static class StorageNetworkProductionSettingsText
    {
        ...
        public static string GetProductionStateText(Storage storage, ComplexFabricator fabricator)
        {
            if (StorageNetworkStorageRules.IsOfflineNetworkServer(storage))
            {
        ...
        {
            return GetProductionStateText(null, fabricator);
        }

        public static Color GetProductionStateColor(Storage storage, ComplexFabricator fabricator)
        {
            if (StorageNetworkStorageRules.IsOfflineNetworkServer(storage))
            {
                return new Color(0.62f, 0.24f, 0.24f, 1f);
            }
        ...
        {
            return GetProductionStateColor(null, fabricator);
        }
