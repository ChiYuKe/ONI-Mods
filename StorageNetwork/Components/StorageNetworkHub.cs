...
namespace StorageNetwork.Components
{
    ...
    public class StorageNetworkHub : KMonoBehaviour, ISidescreenButtonControl, IStorageNetworkConnectable
    {
        [Serialize]
        ...
        public int InputCell => Grid.CellAbove(Cell);

        public int OutputCell => Cell;
        ...
        {
            if (snapshotRevision == StorageNetworkRegistry.Revision)
            {
                return;
            }

            snapshot = StorageNetworkRegistry.BuildSnapshot(this);
            snapshotRevision = StorageNetworkRegistry.Revision;
        }

        public void RefreshNetworkTotals()
        {
            snapshot = StorageNetworkRegistry.BuildSnapshot(this);
            snapshotRevision = StorageNetworkRegistry.Revision;
        }
